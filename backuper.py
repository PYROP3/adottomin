...
dbfile = os.path.join(args.home, args.location, 'backup_main_table.db')
...
def backup_needed():
    ...
    for file in db.sql_files:
        ...
        md5 = subprocess.run(["md5sum", os.path.join(args.home, file)], capture_output=True).stdout.split()[0].decode(encoding='UTF-8')
